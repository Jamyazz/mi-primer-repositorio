...
export class CarrouselGrandeComponent {
  imagenes: string[] = [
    ...
    "carrouselGrande3.webp",
    "carrouselGrande4.webp",
    "carrouselGrande5.webp"
  ];
  ...
  reviews: string[] = [
    ...
    "Después de que su familia es brutalmente asesinada, un chico de buen corazón llamado Tanjiro Kamado decide convertirse en Demon Slayer con la esperanza de convertir a su hermana menor Nezuko en humana.",
